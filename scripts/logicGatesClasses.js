        ...
        this.delete = () => {
            ...
            if (this.connectionLine !== null) {
                lines.forEach((line) => {
                    ...
                    if (
                        line.startNode.id === this.id ||
                        line.endNode.id === this.id
                    ) {
                        line.delete();
                    }
                });
...
class StartNode {
    constructor(x, y) {
        ...
        this.update = () => {
            if (this.connectionLine !== null)
                this.value = this.connectionLine.value;
        ...
        this.draw = () => {
            if (
                ...
                if (Math.abs(this.p - this.x) > Math.abs(this.y - this.q)) {
                    this.curveStrength =
                        Math.abs(this.y - this.q) / (2 * globalScale);
                } else {
                    this.curveStrength =
                        Math.abs(this.p - this.x) / (2 * globalScale);
                }
...
class AndNode {
    constructor(x, y) {
        ...
        for (let i = 0; i < 2; ++i) {
            this.inputs.push(
                new StartNode(this.x, this.y + inputGap * (i + 1))
            );
